...
<br><br>
<h4>Miksi eduskuntaan:</h4><br>
<input type="text" name="miksi" value="<%=resultSet.getString("miksi_eduskuntaan") %>">
<br>
<h4>Mita asioita haluat edistaa:</h4><br>
<input type="text" name="mita" value="<%=resultSet.getString("mita_asioita_haluat_edistaa") %>">
<br>
<h4>Ammatti:</h4><br>
