...
<body>
	<div id="container">
		...
		<%
			List<Ehdokkaat> candidateList = (List<Ehdokkaat>) request.getAttribute("candidateList");
			...
			request.setAttribute("result", prosentit);
		...
		<%
			...
			if (jarjestysnumero < candidateList.size()) {
		%>
		...
		<%
			if (seParasEhdokas.getPicture() == null) {
		%><i>Candidate doesn't upload photo yet!</i>
		<%
			} else {
		%>
		<img src="<%=seParasEhdokas.getPicture()%>" alt="picture"
