 ...
 * @author Jonne
 */
public class Kayttaja implements Serializable { //user
...
//	private final ArrayList<Integer> vastaus = new ArrayList<>(20);
	private ArrayList<Integer> vastaus = new ArrayList<>(22);//answer
    ArrayList<Tuple<Integer, Integer>> pisteet = new ArrayList<>(22);//score
 private final static Logger logger = Logger.getLogger(Loki.class.getName());

    /**
     * Kayttaja-olioon tallennetaan vaalikoneen käyttäjän tietoja. //the user object stores the information of the user of the election machine
     */
//    public Kayttaja() {
//
...
//    }
    ...
    public void taytaVastauksetJaPisteet() { // fill out answer and score 

        //täytelläänhän listat valmiiksi //fill the lists after all 
        for (int i = 0; i <21; i++) {
            this.vastaus.add(0);
            this.pisteet.add(new Tuple<>(0, 0));
        }
