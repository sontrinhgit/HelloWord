...
public class Ehdokkaat implements Serializable {
    ...
    @NotNull
    @Column(name = "EHDOKAS_ID")//idOfCandidate
    private Integer ehdokasId;
    @Size(max = 25)
    @Column(name = "SUKUNIMI")//lastName
    private String sukunimi;
    @Size(max = 25)
    @Column(name = "ETUNIMI")//firstName
    private String etunimi;
    @Size(max = 50)
    @Column(name = "PUOLUE")//party
    private String puolue;
    @Size(max = 25)
    @Column(name = "KOTIPAIKKAKUNTA")//officeMunicipality
    private String kotipaikkakunta;
    @Column(name = "IKA")//age
    private Integer ika;
    @Size(max = 250)
    @Column(name = "MIKSI_EDUSKUNTAAN")//Why parliament?
    private String miksiEduskuntaan;
    @Size(max = 2_000)
    @Column(name = "MITA_ASIOITA_HALUAT_EDISTAA")//What do you want to promote?
    private String mitaAsioitaHaluatEdistaa;
    @Size(max = 50)
    @Column(name = "AMMATTI")//profession
